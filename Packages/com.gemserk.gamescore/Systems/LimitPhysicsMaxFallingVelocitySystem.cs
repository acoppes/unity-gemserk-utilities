...
namespace Game.Systems
{
    public class LimitPhysicsMaxFallingVelocitySystem : BaseSystem, IEcsRunSystem
    {
        ...
        readonly EcsFilterInject<Inc<Physics2dComponent, LimitMaxFallingVelocityComponent, ConfigurationScriptComponent>, Exc<DisabledComponent>> physics2dFilter = default;
